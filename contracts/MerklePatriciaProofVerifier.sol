    ...
    function extractProofValue(
        ...
        for (uint256 i = 0; i < stack.length; i++) {
            ...
            if (i == 0 && rootHash != stack[i].rlpBytesKeccak256()) {
                revert("rootHash doesn't match");
            }
            // ... whereas all other nodes are hashed with the MPT
            // hash function.
            if (i != 0 && nodeHashHash != _mptHashHash(stack[i])) {
                revert("nodeHash doesn't match");
            }
            ...
            if (node.length == 2) {
                ...
                if (prefixLength < nodeKey.length) {
                    ...
                    if (i < stack.length - 1) {
                        ...
                        revert(
                            "prefixLength < nodeKey.length && i < stack.length - 1"
                        );
                    }
                ...
                if (isLeaf) {
                    ...
                    if (i < stack.length - 1) {
                        ...
                        revert("isLeaf && i < stack.length - 1");
                    }
                ...
                if (mptKeyOffset != mptKey.length) {
                    ...
                    if (_isEmptyBytesequence(node[nibble])) {
                        ...
                        if (i != stack.length - 1) {
                            ...
                            revert(
                                "_isEmptyBytesequence(node[nibble]) && i != stack.length - 1"
                            );
                        }
                    ...
                    if (i != stack.length - 1) {
                        ...
                        revert(
                            "mptKeyOffset == mptKey.length && i != stack.length - 1"
                        );
                    }
